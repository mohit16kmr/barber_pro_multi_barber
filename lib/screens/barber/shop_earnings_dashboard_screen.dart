  ...
  Widget build(BuildContext context) {
    return Consumer<BarberProvider>(
      builder: (context, barberProvider, _) {
        ...
        final totalAmount = incomes.fold<double>(0.0, (sum, i) => sum + (i.dailyEarnings));
        final bookings = incomes.fold<int>(0, (sum, i) => sum + (i.bookingsCompleted));
        final barbersCount = incomes.length;
        final averagePerBarber = barbersCount > 0 ? totalAmount / barbersCount : 0.0;
        ...
        final allBarbers = barberProvider.allBarberIncomes.entries.map((e) => {
              'id': e.key,
              'name': e.key,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _buildEarningsStatItem(
                            label: 'Avg/Barber',
                            value: 'Rs. ${(averagePerBarber).toStringAsFixed(0)}',
                    ...
                    itemBuilder: (ctx, idx) {
                      ...
                      final earningsKey = _selectedPeriod == 0
                          ...
                          : _selectedPeriod == 1
                              ...
                              : 'totalEarnings';
                      final bookingsKey =
                          _selectedPeriod == 0 ? 'bookingsToday' : 'bookings';
                          ...
                          children: [
                            ...
                            ClipRRect(
                              ...
                              child: LinearProgressIndicator(
                                value: ((barber[earningsKey] as num? ?? 0) /
